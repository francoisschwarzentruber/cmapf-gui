...
window.onload = () => {
    ...
    document.getElementById("helptextarea").onclick = () => alert("In the textbox, you can write either a configuration or an execution. Example of a configuration: <2, 3, 6> is a configuration of three agents where the first agent is at location 2, the second at 3 and the third at 6. Example of an execution: [[1, 4, 5], [2, 7, 8]] is an execution with 2 agents of length 3. The path of the first agent is 1, 4, 5. The path of the second agent is 2, 7, 8.")
}